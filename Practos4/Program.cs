...
namespace ejednevnik
{
    internal class note
    {
        ...
        public void addInfo()
        {
            Console.WriteLine("Введите записи которые хотите сделать : ");
            ...
            while (true)
            {
                ...
                if (key.Key == ConsoleKey.Enter)
                {
                    if (numofnotes != 0)
                    {
                        if (pos == (numofnotes + 1))
                        {
                            Console.WriteLine("Так же введите данные чтобы создать записку: : ");
                    ...
                    if (numofnotes == 0)
                    {
                        Console.WriteLine("Сделайте название записки: ");
                        string name = Console.ReadLine();
                        note _name_ = new note();
                        _name_.Name = name;
                        _name_.Date = day.Date;
